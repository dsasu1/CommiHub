...
export class AppsessionService {
  ...
  IsUserLoggedInChange: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(
    false
  );
  LeftMenuOpenChange: BehaviorSubject<boolean> = new BehaviorSubject<boolean>(
    false
  );
  AppTitleChange: Subject<string> = new Subject<string>();
  UserSessionChange: BehaviorSubject<UserSession> = new BehaviorSubject<
    UserSession
  >(null);
  currentUnviewdNotificationCountChange: BehaviorSubject<
    number
  ...
  selectedPropertyChange: Subject<PropertyInformation> = new Subject<
    PropertyInformation
  >();
  ...
  logIn(value: UserSession, rememberMe: boolean) {
    if (value != null) {
      ...
      this.addToSession(
        AppConstants.SessionKeyUser,
        value.userVM.loginSessionId
      );
